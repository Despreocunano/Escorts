        ...
        {models.map((model) => (
          <div key={model.id} className="flex flex-col">
            ...
            >
              ...
              {model.is_featured && (
                <div className="absolute top-4 left-4 bg-[#9F8E6A]/30 backdrop-blur-xl p-2 rounded-full z-10 border border-[#9F8E6A]/20 group-hover:px-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white text-xs font-medium tracking-[0.15em] whitespace-nowrap overflow-hidden w-0 group-hover:w-24 transition-all duration-300">
                      DESTACADA
                    </span>
                  </div>
                </div>
